...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgsorgidprojectsprojectidbuildtargetsSettingsScm :  IEquatable<OrgsorgidprojectsprojectidbuildtargetsSettingsScm>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <param name="Subdirectory">subdirectory to build from.</param>
        /// <param name="_Client">perforce only client workspace to build from.</param>
        public OrgsorgidprojectsprojectidbuildtargetsSettingsScm(TypeEnum? Type = default(TypeEnum?), string Branch = default(string), string Subdirectory = default(string), string _Client = default(string))
        {
            this.Type = Type;
            this.Branch = Branch;
        ...
        {
            return this.Equals(input as OrgsorgidprojectsprojectidbuildtargetsSettingsScm);
        }

        /// <summary>
        /// Returns true if OrgsorgidprojectsprojectidbuildtargetsSettingsScm instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgsorgidprojectsprojectidbuildtargetsSettingsScm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgsorgidprojectsprojectidbuildtargetsSettingsScm input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.Subdirectory.Equals(input.Subdirectory))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Subdirectory != null)
                    hashCode = hashCode * 59 + this.Subdirectory.GetHashCode();
