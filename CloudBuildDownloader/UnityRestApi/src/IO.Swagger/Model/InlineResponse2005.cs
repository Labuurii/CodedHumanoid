...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2005 :  IEquatable<InlineResponse2005>, IValidatableObject
    {
        ...
        public InlineResponse2005(string Udid = default(string), string Devicename = default(string), string Os = default(string), string Osversion = default(string), string Product = default(string), StatusEnum? Status = default(StatusEnum?))
        {
            // to ensure "Udid" is required (not null)
            if (Udid == null)
            {
                throw new InvalidDataException("Udid is a required property for InlineResponse2005 and cannot be null");
            }
            else
            {
                this.Udid = Udid;
