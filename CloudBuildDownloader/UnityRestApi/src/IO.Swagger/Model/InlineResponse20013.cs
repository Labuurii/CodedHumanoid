...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse20013 :  IEquatable<InlineResponse20013>, IValidatableObject
    {
        ...
        public InlineResponse20013(PlatformEnum? Platform = default(PlatformEnum?), string Label = default(string), string Credentialid = default(string), string Created = default(string), string LastMod = default(string), OrgsorgidprojectsprojectidbuildtargetsCredentialsSigningCredentialResourceRefKeystore Keystore = default(OrgsorgidprojectsprojectidbuildtargetsCredentialsSigningCredentialResourceRefKeystore), Object Links = default(Object))
        {
