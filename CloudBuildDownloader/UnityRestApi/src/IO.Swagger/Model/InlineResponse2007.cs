...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2007 :  IEquatable<InlineResponse2007>, IValidatableObject
    {
        ...
        public InlineResponse2007(HookTypeEnum HookType = default(HookTypeEnum), List<EventsEnum> Events = default(List<EventsEnum>), Object Config = default(Object), bool? Active = true, decimal? Id = default(decimal?))
        {
            // to ensure "HookType" is required (not null)
            if (HookType == null)
            {
                throw new InvalidDataException("HookType is a required property for InlineResponse2007 and cannot be null");
            }
            else
            {
            ...
            if (Config == null)
            {
                throw new InvalidDataException("Config is a required property for InlineResponse2007 and cannot be null");
            }
            else
            {
                this.Config = Config;
