...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgsorgidprojectsprojectidbuildtargetsCredentials1Signing :  IEquatable<OrgsorgidprojectsprojectidbuildtargetsCredentials1Signing>, IValidatableObject
    {
        /// <summary>
        ...
        public OrgsorgidprojectsprojectidbuildtargetsCredentials1Signing(string Credentialid = default(string))
        {
        ...
        {
            return this.Equals(input as OrgsorgidprojectsprojectidbuildtargetsCredentials1Signing);
        }

        /// <summary>
        /// Returns true if OrgsorgidprojectsprojectidbuildtargetsCredentials1Signing instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgsorgidprojectsprojectidbuildtargetsCredentials1Signing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgsorgidprojectsprojectidbuildtargetsCredentials1Signing input)
        {
            if (input == null)
                return false;
