...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2006 :  IEquatable<InlineResponse2006>, IValidatableObject
    {
        ...
        public InlineResponse2006(InlineResponse2006Billing Billing = default(InlineResponse2006Billing), InlineResponse2006Effective Effective = default(InlineResponse2006Effective))
        {
            // to ensure "Billing" is required (not null)
            if (Billing == null)
            {
                throw new InvalidDataException("Billing is a required property for InlineResponse2006 and cannot be null");
            }
            else
            {
            ...
            if (Effective == null)
            {
                throw new InvalidDataException("Effective is a required property for InlineResponse2006 and cannot be null");
            }
            else
            {
        ...
        public InlineResponse2006Effective Effective { get; set; }
