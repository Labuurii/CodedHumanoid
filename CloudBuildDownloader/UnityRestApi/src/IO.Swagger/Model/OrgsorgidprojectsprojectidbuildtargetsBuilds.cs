...
namespace IO.Swagger.Model
{
    ...
    public partial class OrgsorgidprojectsprojectidbuildtargetsBuilds :  IEquatable<OrgsorgidprojectsprojectidbuildtargetsBuilds>, IValidatableObject
    {
        ...
        public OrgsorgidprojectsprojectidbuildtargetsBuilds(decimal? Build = default(decimal?), string Buildtargetid = default(string), string BuildTargetName = default(string), string BuildGUID = default(string), BuildStatusEnum? BuildStatus = default(BuildStatusEnum?), List<OrgsorgidprojectsprojectidbuildtargetsFailureDetails> FailureDetails = default(List<OrgsorgidprojectsprojectidbuildtargetsFailureDetails>), CanceledByEnum? CanceledBy = default(CanceledByEnum?), PlatformEnum? Platform = default(PlatformEnum?), decimal? WorkspaceSize = default(decimal?), string Created = default(string), string Finished = default(string), string CheckoutStartTime = default(string), decimal? CheckoutTimeInSeconds = default(decimal?), string BuildStartTime = default(string), decimal? BuildTimeInSeconds = default(decimal?), string PublishStartTime = default(string), decimal? PublishTimeInSeconds = default(decimal?), decimal? TotalTimeInSeconds = default(decimal?), string LastBuiltRevision = default(string), List<Object> Changeset = default(List<Object>), bool? Favorited = default(bool?), string Label = default(string), bool? Deleted = default(bool?), string DeletedBy = default(string), QueuedReasonEnum? QueuedReason = default(QueuedReasonEnum?), string CooldownDate = default(string), string ScmBranch = default(string), string UnityVersion = default(string), string XcodeVersion = default(string), decimal? AuditChanges = default(decimal?), OrgsorgidprojectsprojectidbuildtargetsProjectVersion ProjectVersion = default(OrgsorgidprojectsprojectidbuildtargetsProjectVersion), string ProjectName = default(string), string ProjectId = default(string), string OrgId = default(string), string OrgFk = default(string), Object Links = default(Object), OrgsorgidprojectsprojectidbuildtargetsTestResults TestResults = default(OrgsorgidprojectsprojectidbuildtargetsTestResults), string Error = default(string))
        {
            this.Build = Build;
