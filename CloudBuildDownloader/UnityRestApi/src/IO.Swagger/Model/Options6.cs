...
namespace IO.Swagger.Model
{
    ...
    public partial class Options6 :  IEquatable<Options6>, IValidatableObject
    {
        ...
        public Options6(HookTypeEnum HookType = default(HookTypeEnum), List<EventsEnum> Events = default(List<EventsEnum>), Object Config = default(Object), bool? Active = true)
        {
            // to ensure "HookType" is required (not null)
            if (HookType == null)
            {
                throw new InvalidDataException("HookType is a required property for Options6 and cannot be null");
            }
            else
            {
            ...
            if (Config == null)
            {
                throw new InvalidDataException("Config is a required property for Options6 and cannot be null");
            }
            else
            {
                this.Config = Config;
