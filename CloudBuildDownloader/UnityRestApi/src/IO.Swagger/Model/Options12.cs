...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Options12 :  IEquatable<Options12>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Options12" /> class.
        /// </summary>
        /// <param name="Favorited">Favorited.</param>
        /// <param name="Label">Label.</param>
        public Options12(bool? Favorited = default(bool?), string Label = default(string))
        {
        ...
        {
            return this.Equals(input as Options12);
        }

        /// <summary>
        /// Returns true if Options12 instances are equal
        /// </summary>
        /// <param name="input">Instance of Options12 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Options12 input)
        {
            if (input == null)
                return false;
