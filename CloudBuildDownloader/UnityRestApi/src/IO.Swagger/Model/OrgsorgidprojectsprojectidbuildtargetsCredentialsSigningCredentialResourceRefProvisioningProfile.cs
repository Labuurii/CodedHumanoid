...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgsorgidprojectsprojectidbuildtargetsCredentialsSigningCredentialResourceRefProvisioningProfile :  IEquatable<OrgsorgidprojectsprojectidbuildtargetsCredentialsSigningCredentialResourceRefProvisioningProfile>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <param name="Uuid">generated UUID of the profile.</param>
        ...
        public OrgsorgidprojectsprojectidbuildtargetsCredentialsSigningCredentialResourceRefProvisioningProfile(string TeamId = default(string), string BundleId = default(string), string Uuid = default(string), string Expiration = default(string), bool? IsEnterpriseProfile = default(bool?), TypeEnum? Type = default(TypeEnum?), decimal? NumDevices = default(decimal?), string Uploaded = default(string))
        {
            this.TeamId = TeamId;
        ...
        /// </summary>
        /// <value>generated UUID of the profile</value>
        ...
        {
            return this.Equals(input as OrgsorgidprojectsprojectidbuildtargetsCredentialsSigningCredentialResourceRefProvisioningProfile);
        }
        ...
        /// </summary>
        /// <param name="input">Instance of OrgsorgidprojectsprojectidbuildtargetsCredentialsSigningCredentialResourceRefProvisioningProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgsorgidprojectsprojectidbuildtargetsCredentialsSigningCredentialResourceRefProvisioningProfile input)
        {
            if (input == null)
                return false;
