...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgsorgidprojectsprojectidbuildtargetsSettingsPlatform :  IEquatable<OrgsorgidprojectsprojectidbuildtargetsSettingsPlatform>, IValidatableObject
    {
        /// <summary>
        ...
        public OrgsorgidprojectsprojectidbuildtargetsSettingsPlatform(string BundleId = default(string), string XcodeVersion = default(string))
        {
        ...
        {
            return this.Equals(input as OrgsorgidprojectsprojectidbuildtargetsSettingsPlatform);
        }

        /// <summary>
        /// Returns true if OrgsorgidprojectsprojectidbuildtargetsSettingsPlatform instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgsorgidprojectsprojectidbuildtargetsSettingsPlatform to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgsorgidprojectsprojectidbuildtargetsSettingsPlatform input)
        {
            if (input == null)
                return false;
