...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse20014 :  IEquatable<InlineResponse20014>, IValidatableObject
    {
        ...
        public InlineResponse20014(PlatformEnum? Platform = default(PlatformEnum?), string Label = default(string), string Credentialid = default(string), string Created = default(string), string LastMod = default(string), OrgsorgidprojectsprojectidbuildtargetsCredentialsSigningCredentialResourceRefCertificate Certificate = default(OrgsorgidprojectsprojectidbuildtargetsCredentialsSigningCredentialResourceRefCertificate), OrgsorgidprojectsprojectidcredentialssigningiosProvisioningProfile ProvisioningProfile = default(OrgsorgidprojectsprojectidcredentialssigningiosProvisioningProfile), Object Links = default(Object))
        {
        ...
        public OrgsorgidprojectsprojectidcredentialssigningiosProvisioningProfile ProvisioningProfile { get; set; }
