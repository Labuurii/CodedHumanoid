...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgsorgidprojectsprojectidbuildtargetsCredentials1 :  IEquatable<OrgsorgidprojectsprojectidbuildtargetsCredentials1>, IValidatableObject
    {
        /// <summary>
        ...
        public OrgsorgidprojectsprojectidbuildtargetsCredentials1(OrgsorgidprojectsprojectidbuildtargetsCredentials1Signing Signing = default(OrgsorgidprojectsprojectidbuildtargetsCredentials1Signing))
        {
        ...
        {
            return this.Equals(input as OrgsorgidprojectsprojectidbuildtargetsCredentials1);
        }

        /// <summary>
        /// Returns true if OrgsorgidprojectsprojectidbuildtargetsCredentials1 instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgsorgidprojectsprojectidbuildtargetsCredentials1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgsorgidprojectsprojectidbuildtargetsCredentials1 input)
        {
            if (input == null)
                return false;
