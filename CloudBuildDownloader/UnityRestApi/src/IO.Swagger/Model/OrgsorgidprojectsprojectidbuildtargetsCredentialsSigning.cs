...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgsorgidprojectsprojectidbuildtargetsCredentialsSigning :  IEquatable<OrgsorgidprojectsprojectidbuildtargetsCredentialsSigning>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="CredentialResourceRef">CredentialResourceRef.</param>
        public OrgsorgidprojectsprojectidbuildtargetsCredentialsSigning(string Credentialid = default(string), OrgsorgidprojectsprojectidbuildtargetsCredentialsSigningCredentialResourceRef CredentialResourceRef = default(OrgsorgidprojectsprojectidbuildtargetsCredentialsSigningCredentialResourceRef))
        {
            this.Credentialid = Credentialid;
            this.CredentialResourceRef = CredentialResourceRef;
        }
        ...
        {
            return this.Equals(input as OrgsorgidprojectsprojectidbuildtargetsCredentialsSigning);
        }

        /// <summary>
        /// Returns true if OrgsorgidprojectsprojectidbuildtargetsCredentialsSigning instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgsorgidprojectsprojectidbuildtargetsCredentialsSigning to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgsorgidprojectsprojectidbuildtargetsCredentialsSigning input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CredentialResourceRef == input.CredentialResourceRef ||
                    (this.CredentialResourceRef != null &&
                    this.CredentialResourceRef.Equals(input.CredentialResourceRef))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CredentialResourceRef != null)
                    hashCode = hashCode * 59 + this.CredentialResourceRef.GetHashCode();
                return hashCode;
            }
        }
