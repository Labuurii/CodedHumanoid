...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse20012 :  IEquatable<InlineResponse20012>, IValidatableObject
    {
        ...
        /// <param name="Enabled">whether this target can be built by the API.</param>
        /// <param name="Settings">Settings.</param>
        /// <param name="Credentials">Credentials.</param>
        /// <param name="Builds">Builds.</param>
        /// <param name="Links">Links.</param>
        public InlineResponse20012(string Name = default(string), PlatformEnum? Platform = default(PlatformEnum?), string Buildtargetid = default(string), bool? Enabled = default(bool?), OrgsorgidprojectsprojectidbuildtargetsSettings Settings = default(OrgsorgidprojectsprojectidbuildtargetsSettings), OrgsorgidprojectsprojectidbuildtargetsCredentials Credentials = default(OrgsorgidprojectsprojectidbuildtargetsCredentials), List<OrgsorgidprojectsprojectidbuildtargetsBuilds> Builds = default(List<OrgsorgidprojectsprojectidbuildtargetsBuilds>), Object Links = default(Object))
        {
            this.Name = Name;
