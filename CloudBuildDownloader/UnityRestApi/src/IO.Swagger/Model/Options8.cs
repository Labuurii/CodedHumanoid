...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Options8 :  IEquatable<Options8>, IValidatableObject
    {
        /// <summary>
        /// Defines Platform
        /// </summary>
        ...
        {
            return this.Equals(input as Options8);
        }

        /// <summary>
        /// Returns true if Options8 instances are equal
        /// </summary>
        /// <param name="input">Instance of Options8 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Options8 input)
        {
            if (input == null)
                return false;
