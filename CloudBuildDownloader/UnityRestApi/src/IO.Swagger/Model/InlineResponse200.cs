...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse200 :  IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        public InlineResponse200(string Name = default(string), string Value = default(string), List<string> XcodeVersions = default(List<string>), bool? Hidden = default(bool?))
        {
            this.Name = Name;
            this.Value = Value;
