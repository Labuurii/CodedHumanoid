...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Options5 :  IEquatable<Options5>, IValidatableObject
    {
        /// <summary>
        ...
        public Options5(string Name = default(string), ProjectsSettings Settings = default(ProjectsSettings), bool? Disabled = default(bool?), bool? DisableNotifications = default(bool?))
        {
            this.Name = Name;
        ...
        {
            return this.Equals(input as Options5);
        }

        /// <summary>
        /// Returns true if Options5 instances are equal
        /// </summary>
        /// <param name="input">Instance of Options5 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Options5 input)
        {
            if (input == null)
                return false;
