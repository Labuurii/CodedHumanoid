...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgsorgidprojectsprojectidbuildtargetsCredentials :  IEquatable<OrgsorgidprojectsprojectidbuildtargetsCredentials>, IValidatableObject
    {
        /// <summary>
        ...
        public OrgsorgidprojectsprojectidbuildtargetsCredentials(OrgsorgidprojectsprojectidbuildtargetsCredentialsSigning Signing = default(OrgsorgidprojectsprojectidbuildtargetsCredentialsSigning))
        {
        ...
        {
            return this.Equals(input as OrgsorgidprojectsprojectidbuildtargetsCredentials);
        }

        /// <summary>
        /// Returns true if OrgsorgidprojectsprojectidbuildtargetsCredentials instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgsorgidprojectsprojectidbuildtargetsCredentials to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgsorgidprojectsprojectidbuildtargetsCredentials input)
        {
            if (input == null)
                return false;
