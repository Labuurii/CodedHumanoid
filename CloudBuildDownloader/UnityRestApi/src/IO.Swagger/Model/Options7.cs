...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Options7 :  IEquatable<Options7>, IValidatableObject
    {
        /// <summary>
        /// Defines HookType
        /// </summary>
        ...
        public Options7(HookTypeEnum HookType = default(HookTypeEnum), List<EventsEnum> Events = default(List<EventsEnum>), Object Config = default(Object), bool? Active = true)
        {
            // to ensure "HookType" is required (not null)
            if (HookType == null)
            {
                throw new InvalidDataException("HookType is a required property for Options7 and cannot be null");
            }
            else
            {
            ...
            if (Config == null)
            {
                throw new InvalidDataException("Config is a required property for Options7 and cannot be null");
            }
            else
            {
                this.Config = Config;
        ...
        {
            return this.Equals(input as Options7);
        }

        /// <summary>
        /// Returns true if Options7 instances are equal
        /// </summary>
        /// <param name="input">Instance of Options7 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Options7 input)
        {
            if (input == null)
                return false;
