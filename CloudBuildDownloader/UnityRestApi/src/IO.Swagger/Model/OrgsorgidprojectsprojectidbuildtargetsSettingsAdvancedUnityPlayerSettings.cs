...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerSettings :  IEquatable<OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerSettings>, IValidatableObject
    {
        /// <summary>
        ...
        public OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerSettings(OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerSettingsAndroid Android = default(OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerSettingsAndroid))
        {
        ...
        {
            return this.Equals(input as OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerSettings);
        }

        /// <summary>
        /// Returns true if OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerSettings input)
        {
            if (input == null)
                return false;
