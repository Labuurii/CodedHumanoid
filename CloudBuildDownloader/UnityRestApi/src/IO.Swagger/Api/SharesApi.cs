...
namespace IO.Swagger.Api
{
    ...
    public partial class SharesApi : ISharesApi
    {
        ...
        {
             ApiResponse<OrgsorgidprojectsprojectidbuildtargetsBuilds> localVarResponse = GetShareMetadataWithHttpInfo(shareid, include);
        ...
        {
             ApiResponse<OrgsorgidprojectsprojectidbuildtargetsBuilds> localVarResponse = await GetShareMetadataAsyncWithHttpInfo(shareid, include);
             return localVarResponse.Data;
