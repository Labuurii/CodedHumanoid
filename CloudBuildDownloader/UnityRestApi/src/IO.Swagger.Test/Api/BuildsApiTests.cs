...
namespace IO.Swagger.Test
{
    ...
    public class BuildsApiTests
    {
        ...
        public void GetBuildTest()
        {
            ...
            //Assert.IsInstanceOf<OrgsorgidprojectsprojectidbuildtargetsBuilds> (response, "response is OrgsorgidprojectsprojectidbuildtargetsBuilds");
        }
        ...
        public void GetBuildsTest()
        {
            ...
            //var response = instance.GetBuilds(orgid, projectid, buildtargetid, include, perPage, page, buildStatus, platform, showDeleted, onlyFavorites);
            //Assert.IsInstanceOf<List<OrgsorgidprojectsprojectidbuildtargetsBuilds>> (response, "response is List<OrgsorgidprojectsprojectidbuildtargetsBuilds>");
        }
        ...
        public void GetBuildsForOrgTest()
        {
            ...
            //bool? showDeleted = null;
            //bool? onlyFavorites = null;
            //var response = instance.GetBuildsForOrg(orgid, include, perPage, page, buildStatus, platform, showDeleted, onlyFavorites);
            //Assert.IsInstanceOf<List<OrgsorgidprojectsprojectidbuildtargetsBuilds>> (response, "response is List<OrgsorgidprojectsprojectidbuildtargetsBuilds>");
        }
